...
www = b1win + s1win + b2win
wwL = b1win + s1win - b2cost
Lww = -b1cost + s1win + b2win
wLw = b1win - s1cost + b2win
LwL = -b1cost + s1win - b2cost
...
if b2p == True and s2p == False:
	...
	b2wT = contract + ">" + str(b2str)
	s1wT = contract + "<" + str(s1str)
	b1LT = contract + "<" + str(b1str)
	b2LT = contract + "<" + str(b2str)
